...
// namespace Elementor\Modules\Lottie\Widgets;
...
class IPFS_Lottie_Pinata extends Elementor\Widget_Base {
	...
	public function __construct($data = [], $args = null) {
       ...
       $suffix = defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG ? '' : '.min';
		...
		wp_register_script(
			'lottie',
			plugins_url( '/assets/js/lottie' . $suffix . '.js', IPFS_MEDIA_LIBRARY ),
			[
				'jquery',
			],
			'5.6.10',
		...
		wp_register_script(
			'IPFS-pinata-json',
			plugins_url( '/assets/js/IPFS-pinata-json.js', IPFS_MEDIA_LIBRARY ),
			[
				'jquery',
			],
			'5.6.10',
   ...
   public function localize_settings( array $settings ) {
		$settings['lottie']['defaultAnimationUrl'] = plugins_url( '/assets/json/default.json', IPFS_MEDIA_LIBRARY );
	...
	public function get_name() {
		return 'ipfs_lottie_pinata';
	}

	public function get_title() {
		return esc_html__( 'Pinata Lottie', 'elementor-pro' );
	}

	public function get_script_depends() {
		return [ 'lottie', 'IPFS-pinata-json' ];
	}
	...
	protected function register_controls() {
		$this->start_controls_section( 'lottie', [
			'label' => esc_html__( 'Pinata Lottie', 'elementor-pro' ),
		] );
