...
class IPFS_Lottie_Web3 extends Elementor\Widget_Base {
   ...
   public function localize_settings( array $settings ) {
	...
	public function get_name() {
		return 'ipfs_lottie_web3';
	}

	public function get_title() {
		return esc_html__( 'Web3.Storage Lottie', 'elementor-pro' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section( 'lottie', [
			'label' => esc_html__( 'Web3 Lottie', 'elementor-pro' ),
		] );
