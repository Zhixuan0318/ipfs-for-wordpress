 ...
 * @since 1.0.0
 */
class Image_Web3 extends Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Web3.Storage Image', 'elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'image',
			[
				'label' => esc_html__( 'Choose Web3.Storage', 'elementor' ),
				'type' => 'ipfs_web3',
				'dynamic' => [
					'active' => true,
				],
		...
		$this->add_responsive_control(
			'skeleton-loading',
			[
				'label' => esc_html__( 'Skeleton Loading', 'elementor' ),
				'type' => Elementor\Controls_Manager::SELECT,
				'options' => [
					'on' => esc_html__( 'On', 'elementor' ),
					'off' => esc_html__( 'Off', 'elementor' ),
				],
				'default' => 'off'
			]
		);
	...
	private function has_skeleton( $settings ) {
		return ( ! empty( $settings['skeleton-loading'] ) && 'off' !== $settings['skeleton-loading'] );
	}
	...
	protected function render() {
		...
		$has_skeleton = $this->has_skeleton( $settings );

		if ( $has_skeleton ) :

			?><div class="IPFS-skeleton-loading"><?php
