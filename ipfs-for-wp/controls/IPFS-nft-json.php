 ...
 * @since 1.0.0
 */
class Elementor_Ipfs_NFT_Json_Library_Control extends Control_Base_Multiple
{
    ...
    public function enqueue(  ) {
        ...
        wp_register_script(
            'IPFS-nft-json-library',
            plugins_url( '/assets/js/IPFS-nft-json-library.js', IPFS_MEDIA_LIBRARY ),
            [ 'jquery', 'IPFS_masonry', 'IPFS_imagesloaded' ],
            '1.0.9'
        );

        wp_enqueue_script( 'IPFS-nft-json-library' );

        wp_localize_script( 'IPFS-nft-json-library', 'ajax_vars_nft_json',
            array(
    ...
    public function content_template() {
        ...
        <div class="elementor-control-field elementor-control-media">
            ...
            <div class="elementor-control-media__file elementor-control-preview-area" data-control="IPFS-NFT-Json">
