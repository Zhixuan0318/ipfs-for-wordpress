 ...
 * @since 1.0.0
 */
class Elementor_Ipfs_Pinata_Json_Library_Control extends Control_Base_Multiple
{
    ...
    public function enqueue(  ) {
        ...
        wp_register_script(
            'IPFS-pinata-json-library',
            plugins_url( '/assets/js/IPFS-pinata-json-library.js', IPFS_MEDIA_LIBRARY ),
            [ 'jquery', 'IPFS_masonry', 'IPFS_imagesloaded' ],
            '1.0.9'
        );

        wp_enqueue_script( 'IPFS-pinata-json-library' );

        wp_localize_script( 'IPFS-pinata-json-library', 'ajax_vars_Pinata_json',
            array(
    ...
    public function content_template() {
        ...
        <div class="elementor-control-field elementor-control-media">
            ...
            <div class="elementor-control-media__file elementor-control-preview-area" data-control="IPFS-Pinata-Json">
