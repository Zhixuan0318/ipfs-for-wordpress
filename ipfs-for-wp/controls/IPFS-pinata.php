 ...
 * @since 1.0.0
 */
class Elementor_Ipfs_Pinata_Library_Control extends Control_Base_Multiple
{
    ...
    public function enqueue(  ) {
        ...
        wp_register_script(
            'IPFS-Pinata',
            plugins_url( '/assets/js/IPFS-pinata.js', IPFS_MEDIA_LIBRARY ),
            [ 'jquery', 'IPFS_masonry', 'IPFS_imagesloaded' ],
            '1.0.6'
        );

        wp_enqueue_script( 'IPFS-Pinata' );

        wp_localize_script( 'IPFS-Pinata', 'ajax_vars_Pinata',
            array(
    ...
    public function content_template() {
        ...
        <div class="elementor-control-field elementor-control-media">
            ...
            <div class="{{{ inputWrapperClasses }}}">
                <div class="elementor-control-media__content elementor-control-tag-area elementor-fit-aspect-ratio" data-control="IPFS-Pinata">
