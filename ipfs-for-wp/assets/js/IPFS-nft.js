window.addEventListener( 'elementor/init', () => {
    ...
    var IPFS_libraryItemView = elementor.modules.controls.BaseMultiple.extend({
        ...
        ui: function() {
            return {
                NFT_opener: 'div[data-control="IPFS-NFT"]',
        ...
        events: function() {
            return {
                'click @ui.NFT_opener': 'loadLibrary',
        ...
        loadLibrary: async function ( event ) {
            ...
            jQuery ( 'body' ).on( 'click', '#IPFS-' + ID + ' .ipfs-insert-image.web3', function () {
                ...
                if ( val != '' || val != null ) {
                    ...
                    const preview = self.ui.NFT_opener.find( '.elementor-control-media__preview' );
        ...
        onReady: function () {
            ...
            if ( typeof this.elementSettingsModel.attributes.image.url != 'undefined' ) {
                ...
                const preview = this.ui.NFT_opener.find( '.elementor-control-media__preview' );
        ...
        loadImages: function ( element ) {
            ...
            jQuery.ajax({
                type: "post",
                dataType: "json",
                url: ajax_vars_NFT.ajaxurl,
                data: { type: 'ipfs_' + ajax_vars_NFT.type, action: 'IPFS_get_images' },
                ...
                success: async function (result) {
                    ...
                    if ( result.count > 0 ) {
                        ...
                        const notFoundHtml = "<div class=\"ipfs_notfound\">\n" +
                            "        <img src=\"" + ajax_vars_NFT.not_found_image + "\" alt=\"Not found\" />\n" +
    ...
    elementor.addControlView( 'ipfs_nft', IPFS_libraryItemView );
