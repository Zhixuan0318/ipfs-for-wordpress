window.addEventListener( 'elementor/init', () => {
    ...
    var IPFS_libraryItemView = elementor.modules.controls.BaseMultiple.extend({
        ...
        ui: function() {
            return {
                opener: 'div[data-control="IPFS-library"]',
        ...
        loadLibrary: async function ( event ) {
            ...
            // jQuery( 'body .modal-wrapper' ).addClass( 'open' );
            ...
            jQuery ( 'body' ).on( 'click', '#IPFS-' + ID + ' .ipfs-insert-image.web3', function () {
                ...
                if ( val != '' || val != null ) {
                    ...
                    const preview = self.ui.opener.find( '.elementor-control-media__preview' );
        ...
        onReady: function () {
            ...
            if ( typeof this.elementSettingsModel.attributes.image.url != 'undefined' ) {
                ...
                const preview = this.ui.opener.find( '.elementor-control-media__preview' );
        ...
        loadImages: function ( element ) {
            ...
            jQuery.ajax({
                type: "post",
                dataType: "json",
                url: _ajax_vars.ajaxurl,
                data: { type: 'ipfs_' + _ajax_vars.type, action: 'IPFS_get_images' },
                ...
                success: async function (result) {
                    ...
                    if ( result.count > 0 ) {
                        ...
                        const notFoundHtml = "<div class=\"ipfs_notfound\">\n" +
                            "        <img src=\"" + _ajax_vars.not_found_image + "\" alt=\"Not found\" />\n" +
    ...
    elementor.addControlView( 'ipfs_web3', IPFS_libraryItemView );
