window.addEventListener( 'elementor/init', () => {
    ...
    var IPFS_libraryItemView = elementor.modules.controls.BaseMultiple.extend({
        ...
        ui: function() {
            return {
                Pinata_opener: 'div[data-control="IPFS-Web3-Json"]',
        ...
        loadImages: function ( element ) {
            ...
            jQuery.ajax({
                type: "post",
                dataType: "json",
                url: ajax_vars_Web3_json.ajaxurl,
                data: { type: 'ipfs_' + ajax_vars_Web3_json.type, fileType: ajax_vars_Web3_json.fileType, action: 'IPFS_get_images' },
                ...
                success: async function (result) {
                    ...
                    if ( result.count > 0 ) {
                        ...
                        jQuery( result.images ).each( ( index, image ) => {
                            const imageHtml = "<div class=\"grid-item\"><img style='height: auto;' src=\"" + ajax_vars_Web3_json.json_icon + "\" alt=\"\"><label class=\"form-control\">\n" + image.name +
                        ...
                        const notFoundHtml = "<div class=\"ipfs_notfound\">\n" +
                            "        <img src=\"" + ajax_vars_Web3_json.not_found_image + "\" alt=\"Not found\" />\n" +
    ...
    elementor.addControlView( 'ipfs_web3_json', IPFS_libraryItemView );
